...
/** Standalone program to remove all currently-valid
 * version artefacts generated by the JsonTreeTransformProvider,
 * and to create and run tasks to create new ones using the
...
public final class MigrateJsonTreesToConceptTrees {
    ...
    /** Remove all currently-valid version artefacts generated by
     * the JsonTreeTransformProvider, and create and run tasks to
     * create new ones using the ConceptTreeTransformProvider.
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            for (VersionArtefact va : vaList) {
                ...
                logger.info("Persisting and running task ...");
                // The process() method persists the task before running it.
                txn.begin();
                taskInfo.process();
                logger.info("... done.");
                txn.commit();
